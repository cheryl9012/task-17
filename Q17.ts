...
let guest: string[] = [" Jennifer", "Aster", "Noman", "Anum"];

while(guest.length>2){
    let removeguest=guest.pop();
    console.log(`Dear ${removeguest} Sorry I can't  invited you to dinner`);
}
guest.forEach((Guest) => console.log(`Dear ${Guest}, you are still invited to a dinner.`));
